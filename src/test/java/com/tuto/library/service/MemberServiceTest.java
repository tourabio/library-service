...
class MemberServiceTest {
    ...
    void shouldThrowMemberNotFoundException_whenDeletingNonExistentMember() {
        ...
        //when
        Throwable thrown=catchThrowable(()->{memberService.deleteMember("");});
        //then
        assertThat(thrown).isInstanceOf(MemberServiceTest.class)
                .hasMessageContaining("Member with ID number1 not found");
    }}
